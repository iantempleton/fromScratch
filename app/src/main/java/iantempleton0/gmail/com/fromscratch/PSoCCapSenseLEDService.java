...
public class PSoCCapSenseLEDService extends Service {
    ...
    private static  int mDimmerState = 0; // will attempt to define dimmer state with int value
...
//            byteVal[0] = (byte) (51); // this writes the value of the dimmer/led pwm signal
//            //mLedSwitchState = true;
//            //mDimmerState = 51;
//        }
//        else {
...
//        }
        ...
        //mLedSwitchState = value; // should be percentage of duty cycle
        mLedCharacteristic.setValue(byteVal);
        mBluetoothGatt.writeCharacteristic(mLedCharacteristic);
    }
